...
<div class="container solid1">
    ...
    <div class="content">
        <form action="<?php echo U('content/content/insert');?>" method="post" enctype="multipart/form-data" >
            ...
            <table class="myaddhome">
                <tr class="graybg">
                   ...
                   <input maxlength="40" type="text" name="title" id="f1" class="width300" >
                    </td>
                </tr>
                <tr class="whitebg">
                    <td class="textr" width="10%">
                    ...
                    <td class="textl"  colspan="7">
<input type="text" maxlength="20" name="keywords" id="bcity" class="width300" >                    </td>
                </tr>
