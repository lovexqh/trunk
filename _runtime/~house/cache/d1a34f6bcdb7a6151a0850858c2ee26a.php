...
<div class="container solid1">
	<p class="xy"><span class="fontw">当前位置：</span>房屋配置管理</p>
	<p class="addbtn"><a href="<?php echo U('house/HomeConfig/add',array('type'=>$type));?>"><span class="addbtnbg">添加配置</span></a>	<input type="button" onclick="allSelect()" class="searchbut" value="全 选">&nbsp;
	...
	<div class="content">
		<table id="selectstate">
			<tr class="homeheard"><td>选择</td><td width="30%">名称</td><td>创建日期</td><td width="25%">操作</td></tr>
		...
		<td class="managehometd"><a href="<?php echo U('house/HomeConfig/edit',array('id'=>$content['id']));?>"><img src="__PUBLIC__/admin/images/updatehome.gif"/>修改</a>
