...
<div class="container solid1">
    <p class="xy"><span class="fontw">当前位置：</span>房屋管理 > 修改房屋类型</p>

    <div class="content">
        <form action="<?php echo U('house/HomeType/saveOrUpdate');?>" method="post" enctype="multipart/form-data" >
            <table class="myaddhome">
                <tr class="graybg">
                    ...
                    <td class="textl"  colspan="7">
                        <input maxlength="40" type="text" name="name" value='<?php echo ($vo["name"]); ?>' class="myinput" id="f1">
                    </td>
                </tr>
