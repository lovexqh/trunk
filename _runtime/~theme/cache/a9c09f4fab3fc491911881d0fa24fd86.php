...
<div class="container solid1">
	...
	<p class="addbtn"><a href="<?php echo U('theme/menu/add');?>"><span class="addbtnbg">添加组</span></a>
	<div class="content">
		<table>
			<tr class="homeheard">
					<td width="10%">序号</td>
...
<td><?php echo ($key+1); ?></td>
		...
		<td class="managehometd"><a href="<?php echo U('theme/menu/add',array('pid'=>$vo['id']));?>"><img src="__PUBLIC__/admin/images/addbtn.gif"/>添加子组</a> | <a href="<?php echo U('theme/menu/edit',array('id'=>$vo['id']));?>"><img src="__PUBLIC__/admin/images/updatehome.gif"/>修改</a>
