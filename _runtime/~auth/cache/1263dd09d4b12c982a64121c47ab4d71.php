...
<div class="container solid1">
	<p class="xy">
		<span class="fontw">当前位置：</span>节点管理 > 修改节点
	</p>

	<div class="content">
		<form action="<?php echo U('auth/Group/saveOrupdate');?>" method="post"
			enctype="multipart/form-data">
			<input type="hidden" name="pid" id="pid" value='<?php echo ($vo["pid"]); ?>'>
			...
			<table class="myaddhome">
				...
				<tr class="graybg">
					...
					<td class="textl" colspan="7"><input maxlength="40"
						type="text" name="name" value='<?php echo ($vo["name"]); ?>' class="myinput"
						id="bname"></td>
				</tr>


				<tr class="whitebg">
					<td class="textr" width="10%"><span class="fontw">序号：</span></td>
					<td class="textl" colspan="7"><input maxlength="40"
						type="text" name="sort" class="myinput" value="<?php echo ($vo["sort"]); ?>">
					</td>
				</tr>
				<tr class="graybg">
