...
<div class="container solid1">
	...
	<p class="addbtn"><a href="<?php echo U('auth/User/add',array('gid'=>$gid));?>"><span class="addbtnbg">添加用户</span></a>
	<div class="content">
		<table>
			<tr class="homeheard">
					<td width="10%">序号</td>
...
<td><?php echo ($key+1); ?></td>
		...
		<td class="managehometd"><!-- <img src="__PUBLIC__/admin/images/addbtn.gif"/>设置角色</a> | --> <a href="<?php echo U('auth/User/edit',array('id'=>$vo['uid']));?>"><img src="__PUBLIC__/admin/images/updatehome.gif"/><?php echo ($vo["realname"]); ?>修改</a>
