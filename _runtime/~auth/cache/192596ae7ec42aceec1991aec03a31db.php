...
<div style="width:84%;float:left;" >
   ...
   <iframe  style="overflow-x:hidden;"  id="content_frame" src="<?php echo U('auth/User/welcome');?>" width="100%"  height="100%" frameborder="no" marginwidth="0"></iframe>
...
<SCRIPT type="text/javascript">
    ...
    var setting = {
        ...
        async:{
            enable:true,
            url:"<?php echo U('auth/Group/showGroupList');?>",
            autoParam:["id"],
    ...
    function beforeClick(treeId, treeNode) {
        ...
        document.getElementById('content_frame').src="<?php echo U('auth/User/user');?>&gid="+treeNode.id;
          return false;
        } else {
            return true;
        }
